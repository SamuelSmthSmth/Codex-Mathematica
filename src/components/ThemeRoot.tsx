...
export default function ThemeRoot({ activeArea, onSelectArea, onOpenProfile }: ThemeProps) {
  ...
  switch (activeTheme) {
    case "theme-student-mixtape":
      themeContent = <ThemeMixtape activeArea={activeArea} onSelectArea={onSelectArea} />;
      break;
    case "theme-diner":
      themeContent = <ThemeDiner activeArea={activeArea} onSelectArea={onSelectArea} />;
      break;
    case "theme-windows-xp":
      themeContent = <ThemeWindowsXP activeArea={activeArea} onSelectArea={onSelectArea} onOpenProfile={onOpenProfile} />;
      break;
    case "theme-modern-desktop":
      themeContent = <ThemeModernDesktop activeArea={activeArea} onSelectArea={onSelectArea} onOpenProfile={onOpenProfile} />;
      break;
    case "theme-scribble":
      themeContent = <ThemeScribble activeArea={activeArea} onSelectArea={onSelectArea} />;
      break;
    default:
